...
BOT_USERNAME = getenv("BOT_USERNAME" , "Pardhan_music_robot")
BOT_NAME = getenv("BOT_NAME" , "PARDHAN")
ASSUSERNAME = getenv("ASSUSERNAME" , "PARDHAN_X_MUSIC")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Shuaib6869/PURVI-MUSIC",)
